        ...
        <nav className="space-y-8 text-sm">
          <div className="space-y-2">
            <div className="flex flex-col ">
              <Link
                to="/"
                className="flex gap-6 py-3 bg-gray-100 px-4 rounded-xl"
              >
                <AiFillHome size="1.5rem"></AiFillHome>
                <p className="text-md font-semibold">Home</p>
              </Link>
              <Link
                to="/"
                className="flex gap-6 py-3 hover:bg-gray-100 rounded-xl px-4 items-center"
              >
                ...
                <p className="text-md font-semibold py-auto">Shorts</p>
              </Link>
              <Link
                to="/"
                className="flex gap-6 py-3 hover:bg-gray-100 rounded-xl px-4 items-center"
              >
                ...
                <p className="text-md font-semibold py-auto">Subscriptions</p>
              </Link>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex flex-col ">
              ...
              >
                ...
                <p className="text-md font-semibold py-auto">Library</p>
              </Link>
              <Link
                to="/"
                className="flex gap-6 py-3 hover:bg-gray-100 rounded-xl px-4 items-center"
              >
                ...
                <p className="text-md font-semibold py-auto">History</p>
              </Link>
              <Link
                to="/"
                className="flex gap-6 py-3 hover:bg-gray-100 rounded-xl px-4 items-center"
              >
                ...
                <p className="text-md font-semibold py-auto">Your Videos</p>
              </Link>
              <Link
                to="/"
                className="flex gap-6 py-3 hover:bg-gray-100 rounded-xl px-4 items-center"
              >
                ...
                <p className="text-md font-semibold py-auto">Watch Later</p>
              </Link>
            </div>
          </div>
        </nav>
